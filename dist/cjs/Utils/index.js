...
exports.detail = exports.search = exports.latest = exports.popular = void 0;
const axios_1 = __importDefault(require("axios"));
const Config_js_1 = require("./Config.js");
const popular = async () => {
    let Result;
    try {
        const { data } = await axios_1.default.get(Config_js_1.API_URL.popular);
        Result = {
            succeed: true,
            result: data,
        };
...
const latest = async () => {
    let Result;
    try {
        const { data } = await axios_1.default.get(Config_js_1.API_URL.latest);
        Result = {
            succeed: true,
            result: data,
        };
...
const search = async (query, page) => {
    let Result;
    try {
        const { data } = await axios_1.default.get(Config_js_1.API_URL.search(query, page ? page : 1));
